...
// IsSpecialPattern verifica se o conteúdo da mensagem segue um padrão especial
...
// IsTimeWindow verifica se o timestamp está dentro da janela temporal especificada
func IsTimeWindow(
	timestamp string,
